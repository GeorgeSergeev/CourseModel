(function() {
    ...
    DashboardSidebarController.$inject = ['$scope', '$state', 'Auth', 'Principal', 'ProfileService', 'LoginService','AlertService'];

    function DashboardSidebarController ($scope, $state, Auth, Principal, ProfileService, LoginService, AlertService) {
        var vm = this;
