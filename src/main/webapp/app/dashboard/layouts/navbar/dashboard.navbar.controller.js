(function() {
    ...
    DashboardNavbarController.$inject = ['$scope', '$state', 'Auth', 'Principal', 'ProfileService', 'LoginService','AlertService'];

    function DashboardNavbarController ($scope, $state, Auth, Principal, ProfileService, LoginService, AlertService) {
        var vm = this;
