(function() {
    ...
    function stateConfig($stateProvider) {
        ...
        .state('student', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/dashboard/entities/student/students.html',
        ...
        .state('student-detail', {
            ...
            views: {
                'content@': {
                    templateUrl: 'app/dashboard/entities/student/student-detail.html',
        ...
        .state('student-detail.edit', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/dashboard/entities/student/student-dialog.html',
        ...
        .state('student.delete', {
            ...
            onEnter: ['$stateParams', '$state', '$uibModal', function($stateParams, $state, $uibModal) {
                $uibModal.open({
                    templateUrl: 'app/dashboard/entities/student/student-delete-dialog.html',
