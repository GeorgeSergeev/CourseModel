...
import static sev.alvioneurope.coursemodel.impl.StudyImpl.SessionStatus.BREAK;
import static sev.alvioneurope.coursemodel.impl.StudyImpl.SessionStatus.GRADUATE;
...
//------------------------ Methods ------------------------------------
	...
	//Механизм Привязки(подключения) курса к учебному процессу. Подготовка рабочих ссылок
	...
	@Override
	//Механизм извещения "Донастройка после JSON"
