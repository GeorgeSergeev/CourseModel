...
VALUES ('Alexander', 'Orel', '9101112233', 'Alexnder@mail.ru', 00012, 0.0),
       ('Alexey', 'Orel', '9112223344', 'Alexey@mail.ru', 00051, 0.0),
       ('Peter', 'New-York', '9123334455', 'Peter@gmail.com', 00052, 0.0),
       ('John', 'London', '9134445566', 'John@rambler.ru', 00033, 0.0),
       ('Gina', 'San-Francisco', '9011112223', 'Gina777@gmail.com', 00031, 0.0),
       ('Leslie Knope', 'Pawnee', '9037773344', 'super-leslie@pawnee.gov', 00003, 0.0),
       ('Ron Swanson', 'Pawnee', '9037773345', 'ron-fokin-swanson@pawnee.gov', 00051, 0.0),
       ('Andy Dwyer', 'Pawnee', '9028877774', 'andy@pawnee.gov', 00050, 0.0),
       ('Ann Perkins', 'Pawnee', '9009887773', 'ann@pawnee.gov', 00049, 0.0);
...
INSERT INTO COURSE_PROGRESS (STUDENT_ID, COURSE_ID, GRADE)
